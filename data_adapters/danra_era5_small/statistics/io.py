"""
I/O helpers for split-aware statistics in the small DANRA/ERA5 STRIDE adapter.
"""
...
from data_adapters.danra_era5_small.statistics.schemas import StatsResult
...
def build_stats_output_path(
    ...
    """
    Build a canonical output path for one statistics JSON file.
    """
    ...
    return root / split_tag / domain_tag / filename
